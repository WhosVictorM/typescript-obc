...
function newSpaceship(name:string, pilot:string, crew_limit:number){
    const spaceship = {
        name,
        pilot,
        crew_limit,
...
function addCrewMembers(member: string, spaceship: {name: string, crew_limit: number, crew:string[]}){
...
function sendSpaceshipInMission(spaceship:{name: string, crew: string[], crew_limit: number, in_mission: boolean}) {
